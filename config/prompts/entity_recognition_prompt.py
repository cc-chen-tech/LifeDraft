...
**硬性类型边界（优先于模型猜测）：**
- "金箍棒"、"天外石"、"龙鳞"、"玉简"、"水珠"、"青石"、"帛书"、"九环锡杖"是物品，不能放入人物或地点。
- "花果山"、"东海龙宫"、"东海"、"西海"、"水帘洞"、"瑶池"、"寒潭"、"灌江口"、"灵台方寸山"、"天裂谷"是地点，不能放入人物或物品。
- 人物姓名后紧跟"立、转、照、守、握、看、说、道"等叙事动作时，只返回姓名本身，不要把动作片段当作新人物。
- "金纹"是物件描述片段，不是人物；除非上下文明确给出完整物品记录，否则不要单独创建实体。
