...
class QuickValidator:
    ...
    # 违禁词列表：打破第四面墙的词汇
    FORBIDDEN_WORDS_ZH = [
        "游戏", "模拟", "系统", "属性值", "精力值", "情绪值",
        "玩家", "NPC", "任务", "等级", "经验值", "技能点",
        "存档", "读档", "重启", "回合", "选项", "剧情线",
    ]
    
    FORBIDDEN_WORDS_EN = [
        "game", "simulation", "system", "stats", "energy points",
        "mood value", "player", "NPC", "quest", "level", "XP",
        "save", "load", "restart", "turn", "option", "storyline",
    ]
    
    # 故事中可能出现的合理词汇（避免误判）
    ALLOWED_CONTEXTS = [
        # "游戏" 在某些上下文中是合理的
        "做游戏", "玩游戏", "游戏厅", "游戏机", "电子游戏",
        "游乐园", "游戏规则", "游戏公司",
    ]
