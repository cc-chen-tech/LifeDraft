...
class RoundFinalizer:
    ...
    def finalize_week(
        self, result: Dict[str, Any], status_callback: Optional[Callable[[str], None]] = None
    ) -> None:
        """
    ...
    def _generate_family_members_details(self, old_format_members: list) -> list:
        ...
        return self.character_creator.generate_family_members_details(
            old_format_members, player_state.character_settings, player_state.player_name or "主角"
        )
