...
class RoundSystemMixin:
    ...
    def _init_round_services(self) -> None:
        ...
        self._choice_processor = RoundChoiceProcessor(
            ...
            current_event_setter=lambda e: setattr(self._event_generator_service, 'current_event', e),
    ...
    def _introduce_pending_character(self, pending_entry: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _generate_custom_choice_effects(self, event_description: str, custom_text: str) -> Dict[str, Any]:
        ...
        if not hasattr(self, '_choice_processor'):
            self._init_round_services()
        return self._choice_processor._generate_custom_choice_effects(event_description, custom_text)
