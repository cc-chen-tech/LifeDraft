...
class TestDirectImports:
    ...
    def test_import_generation_state_classes(self):
        from src.ai.generation_state import (GenerationState, StateTracker,
                                             TransitionReason)
    ...
    def test_import_feature_flags(self):
        from config.feature_flags import (FEATURE_DEFAULTS, get_feature,
                                          reset_features, set_feature)
...
class TestModuleConstants:
    ...
    def test_import_continuation_prompts(self):
        from src.ai.truncation_recovery import (DEFAULT_CONTINUATION_PROMPT_EN,
...
class TestCrossModuleImports:
    ...
    def test_reactive_compressor_constants_exist(self):
        ...
        for protected in PROTECTED_FIELDS:
            assert (
                protected not in DEFAULT_BUDGET_TRIM_ORDER
