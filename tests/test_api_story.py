...
class TestRewriteStory:
    ...
    def test_rewrite_story_success(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
        """Test rewriting a story segment."""
        mock_session.game_loop.ai_generator.rewrite_story_segment.return_value = "Rewritten story content"
        ...
        response = client.post("/api/games/1/rewrite", json={
    ...
    def test_rewrite_story_no_event(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_rewrite_story_no_session(self, client, auth_headers, mock_auth, mock_session_service):
        ...
        mock_session_service.get_or_restore.side_effect = HTTPException(status_code=404, detail="Game not found")
        response = client.post("/api/games/1/rewrite", json={
            "full_story": "Story",
            "segment_to_replace": "Story",
            "user_instruction": "Change it",
    ...
    def test_rewrite_story_error(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
        """Test rewrite error handling."""
        mock_session.game_loop.ai_generator.rewrite_story_segment.side_effect = Exception("AI error")
        mock_session_service.get_or_restore.return_value = mock_session
...
class TestRegenerateStory:
    ...
    def test_regenerate_story_success(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
        ...
        response = client.post("/api/games/1/regenerate", json={
            "language": "zh"
        }, headers=auth_headers)
    ...
    def test_regenerate_returns_new_story_and_options(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_updates_current_event(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_story_no_event(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_story_no_session(self, client, auth_headers, mock_auth, mock_session_service):
    ...
    def test_regenerate_story_error(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_clears_current_event_before_generation(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
...
class TestStoryChat:
    ...
    def test_story_chat_success(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
        """Test chatting with story assistant."""
        mock_session.game_loop.ai_generator.generate_completion.return_value = "The character is brave."
        mock_session_service.get_or_restore.return_value = mock_session

        response = client.post("/api/games/1/chat", json={
    ...
    def test_story_chat_english(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_story_chat_empty_message(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_story_chat_error(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_story_chat_with_history(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
...
class TestRegenerateStreamSSE:
    ...
    def test_regenerate_stream_uses_generate_round_event(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_stream_handles_empty_result(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_stream_handles_no_options(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_stream_handles_exception(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
...
class TestRegenerateEdgeCases:
    ...
    def test_regenerate_with_consistency_retry(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
    ...
    def test_regenerate_with_world_model(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
        ...
        mock_event.model_dump.return_value = {"event_description": "Story", "options": [{"text": "Option"}]}
    ...
    def test_regenerate_session_cleared_cache(self, client, auth_headers, mock_auth, mock_session_service, mock_session):
        """Test that SSE cache is cleared before regeneration."""
        mock_event = MagicMock()
        mock_event.event_description = "Fresh story"
        mock_event.options = [MagicMock(text="Option")]
        mock_event.model_dump.return_value = {"event_description": "Fresh story", "options": [{"text": "Option"}]}
