...
class TestStoryRegeneration:
        ...
        player_state.round_history = [
            {
                "week": 10,
                "round": 0,
                "event_description": "Old story content",
                "summary": "Old summary",
            }
        ]
    ...
    def test_frontend_story_selection_logic(self):
        ...
        short_backend_story = ""
        new_final_story_short = (
            short_backend_story if len(short_backend_story) > 50 else frontend_story
        )
        assert (
            new_final_story_short == frontend_story
