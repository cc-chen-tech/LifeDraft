...
class TestParseTimeReference:
    ...
    def test_parse_english(self):
        ...
        # this weekend
        result = parse_time_reference("this weekend", current_week=5, current_round=1, language="en")
        assert result == {"scheduled_week": 5, "scheduled_round": 2}
        ...
        # this midweek
        result = parse_time_reference("this midweek", current_week=5, current_round=0, language="en")
        assert result == {"scheduled_week": 5, "scheduled_round": 1}
