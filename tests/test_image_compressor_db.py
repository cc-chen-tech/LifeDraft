...
class TestImageCompressorContract:
    ...
    def test_compress_png_to_jpeg(self):
        ...
        compressed = compress_image(
            original, max_dimension=1024, quality=85, output_format="JPEG"
        )
    ...
    def test_compress_resizes_large_image(self):
        ...
        original = _create_test_image(mode="RGB", size=(2000, 2000), format="PNG")
        compressed = compress_image(
            original, max_dimension=500, quality=85, output_format="PNG"
        )
    ...
    def test_compress_preserves_small_image(self):
        ...
        compressed = compress_image(
            original, max_dimension=1024, quality=85, output_format="PNG"
        )
    ...
    def test_compress_maintains_aspect_ratio(self):
        ...
        compressed = compress_image(
            original, max_dimension=400, quality=85, output_format="PNG"
        )
    ...
    def test_compress_quality_affects_size(self):
        ...
        high_q = compress_image(
            original, max_dimension=1024, quality=95, output_format="JPEG"
        )
        low_q = compress_image(
            original, max_dimension=1024, quality=30, output_format="JPEG"
        )
