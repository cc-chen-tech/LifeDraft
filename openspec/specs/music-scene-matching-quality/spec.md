# music-scene-matching-quality Specification

## Purpose
Define the scene-fit extraction, scoring, prompt-building, fallback, and diagnostics contract for matching story moments to NetEase, local-library, and generated AI music.
