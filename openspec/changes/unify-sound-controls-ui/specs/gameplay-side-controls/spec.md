...
- **And** the collapsed control bar SHALL show one "声音" entry with one combined music-and-narration status line
- **And** the collapsed control bar SHALL NOT show separate channel summaries for "背景音乐" or "故事朗读"
