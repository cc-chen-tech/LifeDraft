...
- Do not block the first production read action on runtime voice settings; start with the current local voice/provider state and let settings update future reads when they arrive.
