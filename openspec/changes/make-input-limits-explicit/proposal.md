...
- Expose the same limits in frontend inputs with Unicode-aware counters, submit guards, remaining-character or over-limit feedback, and generated OpenAPI/TypeScript contracts.
