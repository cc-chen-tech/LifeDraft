...
- [x] 2.2 Update story analysis to produce music brief fields plus Netease search queries.
- [x] 2.3 Improve Netease query construction from mood, era, scene type, energy, instruments, and negative cues.
- [x] 2.4 Add deterministic or AI-assisted reranking of Netease search results before playlist merge.
- [x] 2.5 Keep API response compatibility for existing frontend music playback.

## 3. Queue Policy

- [x] 3.1 Extract playlist merge behavior into an explicit queue policy.
...
- [x] 4.2 Add a generation job interface without requiring a final provider implementation.
...
- [x] 6.3 Run the project test gate used for music-related changes.
