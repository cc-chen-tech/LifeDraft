...
run_e2e_browser_impl() {
    ...
    local result=0
    if [ $core_result -ne 0 ] || [ $accessible_control_names_result -ne 0 ] || [ $world_fact_safety_result -ne 0 ] || [ $opening_visible_completion_result -ne 0 ] || [ $music_ai_result -ne 0 ] || [ $character_settings_result -ne 0 ] || [ $story_voice_result -ne 0 ] || [ $minimax_audio_result -ne 0 ] || [ $collection_recognition_result -ne 0 ]; then
        result=1
    fi
